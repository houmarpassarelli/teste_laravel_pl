...
@section("content")
    <div class="card">
            ...
            <div class="row">
                <div class="col-12">
                    <ol class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><strong>Especialidade: </strong>{{ $payload->expertise->label }}</li>
                        <li class="list-group-item"><strong>CRM: </strong>{{ $payload->crm }}</li>
        ...
        <div class="card-footer border-top">
            <a href="{{ route('doctors.index') }}" class="btn btn-danger">Voltar</a>
            <a href="{{ route('doctors.edit', $payload->id) }}" class="btn btn-warning">Editar</a>
        </div>
    </div>
@stop